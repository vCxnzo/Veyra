...
const API_URL = 'https://api.veyra.one';
...
const LoginPage: React.FC<LoginPageProps> = ({
  ...
  const handleAuth = (provider: 'roblox' | 'discord') => {
    ...
    if (provider === 'roblox') {
      window.location.assign(`${API_URL}/auth/roblox`);
      return;
    }
        ...
        >
          ...
          <div className="space-y-3 pt-2">
            ...
            <button
              ...
              className="w-full py-3.5 px-4 rounded-xl bg-slate-800 hover:bg-slate-700/80 border border-slate-700 text-white font-medium text-sm flex items-center justify-center gap-3 transition-all hover:border-slate-600 disabled:opacity-50 disabled:cursor-not-allowed"
            >
              ...
              {loadingProvider === 'roblox' ? (
                ...
                <>
                  <div className="w-5 h-5 bg-rose-500 text-white font-black text-[10px] rounded flex items-center justify-center rotate-12">
                    R
                  </div>
