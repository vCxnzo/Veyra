      ...
      <div className="max-w-md w-full mx-auto my-auto z-10 py-8">
        ...
        >
          <div className="text-center space-y-2">
            ...
            <p className="text-xs text-slate-400">Sign in to manage your Roblox community.</p>
          </div>

          <div className="space-y-3 pt-2">
            {/* Continue with Roblox Button */}
            <button
              onClick={() => handleAuth('roblox')}
              disabled={loadingProvider !== null}
              className="w-full py-3.5 px-4 rounded-xl bg-slate-800 hover:bg-slate-700/80 border border-slate-700 text-white font-medium text-sm flex items-center justify-center gap-3 transition-all hover:border-slate-600 disabled:opacity-50 group"
            >
            ...
            <button
              ...
              disabled={loadingProvider !== null}
              className="w-full py-3.5 px-4 rounded-xl bg-indigo-600 hover:bg-indigo-500 text-white font-medium text-sm flex items-center justify-center gap-3 transition-all shadow-lg shadow-indigo-600/20 disabled:opacity-50"
            >
